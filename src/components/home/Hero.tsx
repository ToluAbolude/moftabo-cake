          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Delicious Cakes for</span>{" "}
                <span className="block text-cake-purple xl:inline">Every Celebration</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link to="/catalog">
                    <Button className="w-full bg-cake-purple hover:bg-cake-dark-purple text-white py-3 px-8 text-base">
                      Order Now
                    </Button>
                  </Link>
                </div>
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link to="/custom">
                    <Button variant="outline" className="w-full border-cake-purple text-cake-purple hover:bg-cake-light-purple py-3 px-8 text-base">
                      Custom Design
                    </Button>
                  </Link>
                </div>
